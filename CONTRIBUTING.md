...
Hi! Thanks for considering contributing to ckantools. :sauropod:
...
- [Issues](https://github.com/NaturalHistoryMuseum/ckantools/issues)
...
This project relates to [CKAN](https://github.com/ckan/ckan). It's not an extension or plugin, but it can only really be used in the context of CKAN.
...
- [The documentation](https://ckantools.readthedocs.io)
- [The existing issues](https://github.com/NaturalHistoryMuseum/ckantools/issues?q=is:issue)
...
We generally use external style guides and tools to help us maintain standardised code. Black will be run with pre-commit.
...
If you're making changes that would affect frontend code like HTML, please make sure they meet level AA of the [Web Content Accessibility Guidelines (WCAG)](https://www.w3.org/WAI/standards-guidelines/wcag).

### Documentation changes

Our documentation is generated using [MkDocs](https://www.mkdocs.org), then hosted on [Read the Docs](https://about.readthedocs.com). You can view the current documentation for this repository at [ckantools.readthedocs.io](https://ckantools.readthedocs.io).
